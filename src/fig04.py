"""
Figure 4 caption:
Annual cycle phase for CCMP2 wind speed, highlighting SWARs using the WSP 
maximum criteria. White pixels correspond to points that are not categorized as
having anomalous phase or where the amplitude is not statistically significant.
From $66^\circ$S to $66^\circ$N, 3.39\% of the world's oceans experience 
anomalous wind speed phase.
"""
...
# save figure
fig.savefig(fname="../figs/fig04", bbox_inches="tight", dpi=300)
